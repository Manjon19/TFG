    ...
    <div class="carousel-inner">
      ...
      ?>
            <div class="carousel-item active">
              ...
              <img src="<?php echo BASE_URL."app/assets/img/vehiculos/".$imagenes[$ind]['ref_img']; ?>" class="d-block w-50 mx-auto img-fluid" alt="" />
              <div class="carousel-caption bg-dark text-white mx-auto opacity-75 w-50 d-none d-md-block">
                <h5><?php echo $ofer['descuento'] ?>% de descuento</h5>
                <p><?php echo $ofer['descripcion'] ?></p>
